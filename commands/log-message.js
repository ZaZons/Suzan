...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('log-message')
		.setDescription('Selects a channel as your message log, message related logs will be sent there')
	...
	async execute(interaction) {
		try {
			...
			const sql = `UPDATE guilds SET messageLog = '${logChannel.id}' WHERE guilds.id = '${interaction.guild.id}'`;
