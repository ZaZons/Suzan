...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('log-member')
		.setDescription('Selects a channel as your member log, member related logs will be sent there')
	...
	async execute(interaction) {
		try {
			...
			const sql = `UPDATE guilds SET memberLog = '${logChannel.id}' WHERE guilds.id = '${interaction.guild.id}'`;
			...
			await logChannel.send('Hi, this is your new member log');
